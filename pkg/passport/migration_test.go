...
func (c *migrationClient) Status(context.Context, string, []string, string, string) ([]client.StatusEntry, error) {
	return c.status, nil
}
func (c *migrationClient) PropList(context.Context, string, string, string, string) (map[string]bool, error) {
	return c.props, nil
}
func (c *migrationClient) PropSet(_ context.Context, _ string, _, _ string, paths []string, _, _ string) (string, error) {
	c.sets = append(c.sets, append([]string(nil), paths...))
	return "", nil
}
func (c *migrationClient) Commit(_ context.Context, _ string, paths []string, _, _, _ string) (string, error) {
