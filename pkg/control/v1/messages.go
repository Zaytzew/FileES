...
func (t Ticket) Validate() error {
	...
	case TicketArmPassportAcquisition, TicketSettlePassportAcquisition, TicketExpirePassportPath:
		var p PassportExecutionPayload
		if err := decodeStrict(t.Payload, &p); err != nil {
			return err
		}
		return p.Validate(t.Type == TicketExpirePassportPath)
...
func validateSuccessPayload(r Result) error {
	...
	case TicketArmPassportAcquisition, TicketSettlePassportAcquisition, TicketExpirePassportPath:
		var p PassportExecutionResult
		if err := decodeStrict(r.Result, &p); err != nil {
			return err
		}
		return p.Validate(r.Type)
	case TicketPreparePassportReplacement:
