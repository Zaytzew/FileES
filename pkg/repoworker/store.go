...
func (s *FileStore) path(id string, typ control.TicketType) (string, error) {
	...
	if typ != control.TicketStoragePreflight && typ != control.TicketCreateRepository && typ != control.TicketInitialCommit && typ != control.TicketDeleteRepository && typ != control.TicketPrepareRepositoryRecovery && typ != control.TicketMobilePairing && typ != control.TicketClaimRealmAlias && typ != control.TicketResolveOwnerLabels && typ != control.TicketClientDeactivate && typ != control.TicketRealmRemoveRequest && typ != control.TicketRealmRemoveConfirm && typ != control.TicketLoadRepositoryDump && typ != control.TicketGrantAccess && typ != control.TicketRevokeAccess && typ != control.TicketListGrantRecipients && typ != control.TicketSetRealmVisibility && typ != control.TicketGetRealmPublicBranding && typ != control.TicketSetRealmPublicBranding && typ != control.TicketListPublicShares && typ != control.TicketCreatePublicShare && typ != control.TicketUpdatePublicShare && typ != control.TicketRevokePublicShare && typ != control.TicketDeletePublicShare && typ != control.TicketListUploadChannels && typ != control.TicketCreateUploadChannel && typ != control.TicketUpdateUploadChannel && typ != control.TicketRevokeUploadChannel && typ != control.TicketDeleteUploadChannel && typ != control.TicketListQuarantine && typ != control.TicketHideQuarantine && typ != control.TicketFetchQuarantine && typ != control.TicketListShelf {
