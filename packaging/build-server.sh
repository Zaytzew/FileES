...
for command in filees-admin filees-onboard filees-operation filees-mail filees-ssh-auth filees-entry filees-worker filees-client-entry filees-install filees-rotate; do
	(
		cd "$root"
