...
type DaemonClient interface {
	...
	RepoActivity(ctx context.Context, limit int) (*contract.RepoActivityResult, error)
	NoticeList(ctx context.Context) (*contract.NoticeListResult, error)
	PublicShareListAll(ctx context.Context) (*contract.PublicShareListResult, error)
