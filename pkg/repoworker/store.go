...
func (s *FileStore) path(id string, typ control.TicketType) (string, error) {
	...
	if typ != control.TicketStoragePreflight && typ != control.TicketCreateRepository && typ != control.TicketInitialCommit && typ != control.TicketDeleteRepository && typ != control.TicketMobilePairing {
