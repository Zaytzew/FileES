...
func (s appState) viewModel() ViewModel {
	...
	for _, activation := range s.system.Activations {
		...
		servers = append(servers, ServerViewModel{ID: activation.ServerID, DisplayName: activation.DisplayName, ClientRole: activation.ClientRole, RealmID: activation.RealmID, RealmAlias: activation.RealmAlias, Address: activation.Address, ClientID: activation.ClientID, SSHPort: activation.SSHPort, CanCreateRepositories: activation.CanCreateRepositories, RepositoriesReady: activation.RepositoriesReady, PendingRequiredRepos: activation.PendingRequiredRepos, ReservationCount: s.reservations[activation.ServerID], ReservationsKnown: s.reservationsKnown})
	}
